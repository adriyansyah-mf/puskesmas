...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('uploadimage.dokumentasiperkesmas') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" name="type" value="dokumentasi_rapat_perkesmas" />
...
<script>
    ...
    $('.open-detail-link').on('click', function() {
        ...
        deleteButton.href = "{{ route('deleteimage.dokumentasiperkesmas') }}?name=" + imageName;
