...
<div class="container my-5">
    <div class="jumbotron">
        <div class="container my-5">
            ...
            <div class="row">
                @foreach ($images->where('type', 'perkesmas_lokmun_notulen') as $image)
...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('upload.image', ['prog' => 'perkesmas_lokmun_notulen']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" name="type" value="perkesmas_lokmun_notulen"/>
...
<script>
    ...
    $('.open-detail-link').on('click', function() {
        ...
        image.src = "{{ asset('storage/uploads/lokmun') }}/" + imageName;
        ...
        openDetailButton.href = "{{ asset('storage/uploads/lokmun') }}/" + imageName;

        // Set the href for the "Delete" button
        var deleteButton = document.getElementById('deleteButton');
        deleteButton.href = "{{ route('delete.image') }}?name=" + imageName;
