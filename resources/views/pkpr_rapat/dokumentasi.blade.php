...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('uploadimage.dokumentasipkpr') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" name="type" value="dokumentasi_rapat_pkpr" />
...
<script>
    ...
    $('.open-detail-link').on('click', function() {
        ...
        deleteButton.href = "{{ route('deleteimage.dokumentasipkpr') }}?name=" + imageName;
