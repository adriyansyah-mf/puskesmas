			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{ $item->role }}</td>
						<td>
							<a href="#" class="edit" data-toggle="modal" data-target="#editEmployeeModal" data-id="{{ $item->id }}">
								<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
							</a>
							<a href="#" class="delete" data-toggle="modal" data-target="#deleteEmployeeModal" data-id="{{ $item->id }}">
		...
		<div class="modal-content">
			<form method="post" action="/user">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>Jabatan</label>
						<input type="text" class="form-control @error('posision') is-invalid @enderror" id="posision" name="posision" value="{{ old('posision') }}" required>
					</div>
                    <div class="form-group">
						<label>Role</label>
